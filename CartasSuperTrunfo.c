...
int main() {
  ...
  densidade1 = populacao_cid1 / area_cid1;
  pibpercapita1 = pib_cid1 / (float) populacao_cid1;
  densidade2 = populacao_cid2 / area_cid2;
  pibpercapita2 = pib_cid1 / populacao_cid2;
